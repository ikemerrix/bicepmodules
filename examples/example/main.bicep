// Resource name
param name string = 'isdnsbp'
// Resource suffix
param suffix string = 'isdnsbp'
// Resource location
param location string = resourceGroup().location

// Unique DNS Name for the Public IP used to access the Virtual Machine.
param publicIpDnsLabel string = 'isdnsbp'
...
param virtualMachineExtensionCustomScriptUri string = 'https://raw.githubusercontent.com/isaacmorrison/bicep/main/docs/examples/201/vm-windows-with-custom-script-extension/install.ps1'
